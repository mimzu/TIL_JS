...
slide[1].style.backgroundColor = '#rgba(0,0,0,0.2)'
...
const navLi2 = navGnb.querySelectorAll('li')
const navA = document.querySelectorAll('gnb > li > a')
const navA2 = navLi[0].querySelectorAll('a')
...
function userInfo(){
    // 버튼 클릭 시 사용자가 이력한 아이디, 이름, 비밀번호 확인 알고리즘
